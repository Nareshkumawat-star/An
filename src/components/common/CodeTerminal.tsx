  ...
  return (
    ...
    >
      <motion.div
        ...
        className="aspect-video bg-[#0c0c0e]/90 border border-white/10 rounded-xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] backdrop-blur-xl relative group cursor-default select-none transition-transform duration-200 ease-out"
      >
        {/* Terminal Title Bar */}
        <div
